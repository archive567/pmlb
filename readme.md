...
random dataset: \[iris\](https://github.com/EpistasisLab/penn-ml-benchmarks/raw/master/datasets/classification/iris/iris.tsv.gz)

rectangle check (max 1000 lines):Right (151,5)
